"""LTX-Video backend stub — evaluate during development."""
...
class LTXVideoBackend(VideoBackend):
    """LTX-Video backend stub. Not yet integrated — evaluate during development."""
    ...
    def supports_style(self, style: str) -> bool:
        return style in {"cinematic", "photorealistic", "abstract"}
    ...
    def generate_clip(self, prompt, duration_sec, resolution, fps=24, seed=-1) -> VideoClip:
        raise NotImplementedError("LTX-Video is a stub — not yet integrated.")
